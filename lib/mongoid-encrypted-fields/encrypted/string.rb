...
#
# Usage:
# field :social_security_number, type: Mongoid::Encrypted::String
#
    ...
    class String < ::String
      ...
      class << self
        ...
        def demongoize(object)
          case
            when object.is_a?(Mongoid::Encrypted::String) || object.blank?
              object
            else
              new(Config.cipher.decrypt(object))
          end
        end
        ...
        def mongoize(object)
          case
            when object.is_a?(Mongoid::Encrypted::String)
              object.mongoize
